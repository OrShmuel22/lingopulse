...
echo ""
echo "Next steps:"
echo "  1. Open Raycast → Extensions → Script Commands → Add Script Directory"
echo "     Point it to: $PROJECT_ROOT/scripts/raycast"
echo ""
echo "  2. In Raycast, assign hotkeys to each command (suggested):"
